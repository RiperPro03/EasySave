...
namespace EasySave.Tests.Repositories
{
    public class JobRepositoryTests
    {
        ...
        public void Update_ShouldUpdateJob_WhenJobExists()
        {
            ...
            var retrievedJob = repository.GetAll().FirstOrDefault(j => j.Id == "2");
        ...
        public void GetById_ShouldReturnCorrectJob()
        {
            ...
            var retrievedJob = repository.GetAll().FirstOrDefault(j => j.Id == "3");
            Assert.NotNull(retrievedJob);
